...
for name in [1,2,3,4]:
    ...
    lane_numbers = dd.d6000[name]['roa']['LN']
    self_lanes = dd.d6000[name]['roa']['host_#L']
    sur = dd.d6000[name]['sur']
    vels = dd.d6000[name]['roa']['host_v(km/h)']
    lcs = dd.d6000[name]['roa']['LC']
    ...
    dv.output_video(vels, self_lanes, lcs, lane_numbers, rel_xes_list, rel_ys_list, rel_vys_list, name)