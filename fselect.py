...
if not is_win32:
	gridpy_exe = os.path.join(tools_dir, "./grid.py -log2c -2,9,2 -log2g 1,-11,-2")
	svmtrain_exe=os.path.join(tools_dir, "../svm-train")
	svmpredict_exe=os.path.join(tools_dir, "../svm-predict")
else:
	gridpy_exe = os.path.join(tools_dir, r".\grid.py -log2c -2,9,2 -log2g 1,-11,-2")
	svmtrain_exe= os.path.join(tools_dir, r"..\windows\svmtrain.exe")
	svmpredict_exe= os.path.join(tools_dir, r"..\windows\svmpredict.exe")
